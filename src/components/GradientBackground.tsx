...
export default function GradientBackground({ darkMode = false }: GradientBackgroundProps) {
  ...
  return (
    <>
      ...
      {/* 가장자리 작은 원들 */}
      <div 
        className="absolute top-[40%] -left-[100px] w-[400px] h-[400px] rounded-full opacity-[0.35] blur-[80px] pointer-events-none will-change-transform"
        style={{ 
          background: `radial-gradient(circle, ${gradientColor} 0%, transparent 70%)`,
      ...
      />
      <div 
        className="absolute top-[35%] -right-[120px] w-[450px] h-[450px] rounded-full opacity-[0.35] blur-[80px] pointer-events-none will-change-transform"
        style={{ 
          background: `radial-gradient(circle, ${gradientColor2} 0%, transparent 70%)`,
